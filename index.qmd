...
ggsave("Output/Figures/Figure3_CO2DOC_scatters.pdf", plot =combined_CO2DOCscattters,
       height= 8, width = 8)
...
ggarrange( plot_DOC_q_FC, plot_DOC_q_FC_DC, 
...
```{r, warning =F, message = F, fig.height=10, fig.width=7, fig.cap="exceedance probability plot"}

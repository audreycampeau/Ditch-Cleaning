...
Q_DC4=read.csv("/Users/audreycampeau/Documents/DATA/TROLLBERGET DITCH/discharge johannes/daily/Q_59_daily.Time_Series_Data.2024031816491438.csv", skip=11)
Q_DC2=read.csv("/Users/audreycampeau/Documents/DATA/TROLLBERGET DITCH/discharge johannes/daily/Q_C57_Daily.Time_Series_Data.2024031816461304.csv", skip=11)
Q_DC3=read.csv("/Users/audreycampeau/Documents/DATA/TROLLBERGET DITCH/discharge johannes/daily/Q_60_daily.Time_Series_Data.2024031816502188.csv", skip=11)
Q_C1=read.csv("/Users/audreycampeau/Documents/DATA/TROLLBERGET DITCH/discharge johannes/daily/Q_C01_Daily_PRELIMINARY.Time_Series_Data.2024031816562806.csv", skip=11)

#Data Source: SITES data Portal (retreived in April 2024)
#Q units are m3 s1 (from Sites Data Portal)
Q_C2=read.csv("/Users/audreycampeau/Documents/DATA/TROLLBERGET DITCH/Sites DataPortal/SITES_WB-Q_SVB-VAB-C2_20050406-20231116_daily.csv", skip=24)
Q_C4=read.csv("/Users/audreycampeau/Documents/DATA/TROLLBERGET DITCH/Sites DataPortal/SITES_WB-Q_SVB_KKM-C4_20070529-20231113_L2_daily.csv", skip=23)
Q_C18=read.csv("/Users/audreycampeau/Documents/DATA/TROLLBERGET DITCH/Sites DataPortal/SITES_WB-Q_SVB_DEG-C18_20120425-20231123_L2_daily.csv", skip=22)


#Open Meteo Daily
Meteo=read_xlsx("/Users/audreycampeau/Documents/DATA/TROLLBERGET DITCH/Meteo_Daily.xlsx")
